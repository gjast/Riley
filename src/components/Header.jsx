...
export default function Header() {
	...
	return (
		...
		>
			<div className="relative z-30 flex items-center justify-between gap-3 rounded-2xl bg-black/80 px-3 py-2.5 backdrop-blur-[196px] sm:px-4 sm:py-3 lg:rounded-[24px] lg:px-4">
			...
			{menuOpen ? (
				<>
					...
					<div
						id="mobile-nav"
						className="absolute left-0 right-0 top-[calc(100%+8px)] z-20 flex flex-col gap-1 rounded-2xl border border-[#1E1E20] bg-[#101012] p-4 shadow-xl lg:hidden"
						role="dialog"
						aria-modal="true"
						aria-label={t("header.navLabel")}
					>
