...
/**
 * Landing grid + portfolio detail cards for each case.
 * @type {Array<{
 *   id: string;
 *   img: string;
 *   title: string;
...
export const CASES = [
	{
		...
		cards: [
			{ title: "Gambler — Discovery & UX", description: DESCRIPTION, href: "#" },
			{ title: "Gambler — Web & Illustrations", description: DESCRIPTION, href: "#" },
	...
	},
	{
		...
		cards: [
			{ title: "Frosty White — Product UI", description: DESCRIPTION, href: "#" },
			{ title: "Frosty White — Mobile flows", description: DESCRIPTION, href: "#" },
			{ title: "Frosty White — Design system", description: DESCRIPTION, href: "#" },
		],
	},
	{
		id: "case-3",
		...
		cards: [
			{ title: "Relay — Hero & narrative", description: DESCRIPTION, href: "#" },
	...
	},
	{
		...
		cards: [
			...
			{ title: "Neon Slots — Game chrome", description: DESCRIPTION, href: "#" },
	...
	},
	{
		...
		cards: [
			...
			{ title: "Atlas — Settings & support", description: DESCRIPTION, href: "#" },
		],
	},
	{
		id: "case-6",
		...
		cards: [
			...
			{ title: "Pulse — Activity tracking", description: DESCRIPTION, href: "#" },
			{ title: "Pulse — Social & challenges", description: DESCRIPTION, href: "#" },
		],
	},
	{
		id: "case-7",
		...
		cards: [
			...
			{ title: "Northwind — Tables & filters", description: DESCRIPTION, href: "#" },
	...
	},
	{
		...
		cards: [
			{ title: "Lumen — Search & booking", description: DESCRIPTION, href: "#" },
			{ title: "Lumen — Trip detail", description: DESCRIPTION, href: "#" },
			{ title: "Lumen — Profile & loyalty", description: DESCRIPTION, href: "#" },
		],
	},
	{
		id: "case-9",
		...
		cards: [
			{ title: "Vault — Identity & brand", description: DESCRIPTION, href: "#" },
